...
public class TaskMgtServiceConvert {
    ...
    public TaskMgtServiceConvert() {
        this(RestfulServices.create(AAISliceService.class),RestfulServices.create(GeneralConvertImpl.class));
    }

    public TaskMgtServiceConvert(AAISliceService aaiSliceService,GeneralConvertImpl generalConvert) {
