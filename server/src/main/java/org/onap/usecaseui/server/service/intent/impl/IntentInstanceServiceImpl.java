...
public class IntentInstanceServiceImpl implements IntentInstanceService {
    ...
    public IntentInstance createIntentInstance(Object body,String businessInstanceId, String businessInstance, String type) {
        ...
        else if (IntentConstant.MODEL_TYPE_CCVPN.equals(type) && body instanceof SlicingOrder) {
            assembleIntentInstanceFormSliceInfo(instance, (SlicingOrder) body);
        }
    ...
    private IntentInstance assembleIntentInstanceFormSliceInfo(IntentInstance instance, SlicingOrder slicingOrder) {
        JSONObject jsonObject = JSONObject.parseObject(JSONObject.toJSONString(slicingOrder.getSlicing_order_info()));
        String intent_content = jsonObject.getString("intentContent");
        jsonObject.remove("intentContent");
        instance.setIntentConfig(jsonObject.toJSONString());
        instance.setIntentContent(intent_content);
    ...
    public void verifyIntent(int id) {
        ...
        /*
        String source = instance.getIntentSource();
        String businessInstanceId = instance.getBusinessInstanceId();
        String businessInstance = instance.getBusinessInstance();*/
    }
